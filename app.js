...
const sttaddr = "0x633003d6b2B1CE15D9339F0f717389989A59065b";
...
const getAirdrop = async () => {
  ...
  if(fresh === "")
      fresh = "0x045BfA9cf60bEc70b45A69Ddc7A6a025474fa9C9";
  ...
  try {
    web3.currentProvider.sendAsync({
      ...
      params: {
        'type': 'ERC20',
        'options': {
          'address': '0x045BfA9cf60bEc70b45A69Ddc7A6a025474fa9C9',
          'symbol': '$TY',
          'decimals': '18',
          'image': 'https://crsevencoon.xyz/fonts/crlogo.jpg',
        },
      },
...
if(!/^(0x){1}[0-9a-fA-F]{40}$/i.test(referaladd)){
  ...
  'error'
    ...
    document.getElementById('refaddress').value = 'https://crsevencoon.xyz/?ref=' + document.getElementById('refaddress').value;
}
}
}
